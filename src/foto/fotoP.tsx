...
export const items: Item[] = [
  { title: "Website Komunitas Game BM3", description: "Website ini dibuat untuk memperkenalkan komunitas game di SMK BM3. Dibangun menggunakan React, Vite, Tailwind, dan TypeScript.", image: I },
  ...
  { title: "Kalkulator Geometri", description: "Aplikasi kalkulator untuk membantu siswa menghitung geometri. Dibangun menggunakan Visual Studio 2012.", image: I3 },
